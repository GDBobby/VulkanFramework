...
namespace EWE{
    ...
    namespace Command{
        ...
        namespace Exec{
            ...
            void ViewportScissor(ExecContext& ctx){
                auto* data = reinterpret_cast<ParamPack::ViewportScissor const*>(&ctx.paramPool[ctx.instructions[ctx.iterator].paramOffset]);
    #ifdef EXECUTOR_DEBUGGING
                ctx.Print();
    #endif
            ...
            void ViewportScissorWithCount(ExecContext& ctx){
                auto* data = reinterpret_cast<ParamPack::ViewportScissorWithCount const*>(&ctx.paramPool[ctx.instructions[ctx.iterator].paramOffset]);
                assert(data->currentViewportCount < ParamPack::ViewportScissorWithCount::ArbitraryViewportCountLimit);
                assert(data->currentScissorCount < ParamPack::ViewportScissorWithCount::ArbitraryScissorCountLimit);
    #ifdef EXECUTOR_DEBUGGING
                ctx.Print();
    #endif
            ...
            void BeginLabel(ExecContext& ctx){
    #if EWE_DEBUG_NAMING
                auto* data = reinterpret_cast<ParamPack::Label const*>(&ctx.paramPool[ctx.instructions[ctx.iterator].paramOffset]);
