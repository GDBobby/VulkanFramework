...
constexpr auto static_extension_associations = std::array{
    ...
    ExtensionAssociation{
        ...
        { "VK_KHR_synchronization2", "VK_KHR_spirv_1_4", "VK_EXT_extended_dynamic_state", "VK_KHR_maintenance5", "VK_KHR_pipeline_library" }
    },
    ExtensionAssociation{
        "VK_AMD_anti_lag",
    ...
    ExtensionAssociation{
        ...
        VK_STRUCTURE_TYPE_MAX_ENUM,
        VK_STRUCTURE_TYPE_MAX_ENUM,
        { "VK_KHR_sampler_ycbcr_conversion", "VK_KHR_external_memory", "VK_KHR_dedicated_allocation", "VK_EXT_queue_family_foreign" }
    },
    ExtensionAssociation{
        "VK_ARM_data_graph",
        VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_CREATE_INFO_ARM,
        VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_CREATE_INFO_ARM,
        { "VK_KHR_maintenance5", "VK_KHR_deferred_host_operations" }
    },
    ExtensionAssociation{
        "VK_ARM_format_pack",
    ...
    ExtensionAssociation{
        ...
        { "VK_KHR_get_physical_device_properties2", "VK_KHR_synchronization2" }
    },
    ExtensionAssociation{
    ...
    ExtensionAssociation{
        ...
        VK_STRUCTURE_TYPE_MAX_ENUM,
        { "VK_KHR_get_physical_device_properties2", "VK_EXT_attachment_feedback_loop_layout" }
    },
    ExtensionAssociation{
    ...
    ExtensionAssociation{
        ...
        { "VK_KHR_get_physical_device_properties2", "VK_KHR_buffer_device_address", "VK_EXT_descriptor_indexing", "VK_KHR_synchronization2" }
    },
    ExtensionAssociation{
    ...
    ExtensionAssociation{
        ...
        VK_STRUCTURE_TYPE_MAX_ENUM,
        { "VK_KHR_get_physical_device_properties2", "VK_KHR_dynamic_rendering" }
    },
    ExtensionAssociation{
    ...
    ExtensionAssociation{
        ...
        { "VK_KHR_get_physical_device_properties2", "VK_EXT_fragment_density_map", "VK_KHR_create_renderpass2", "VK_KHR_dynamic_rendering" }
    },
    ExtensionAssociation{
    ...
    ExtensionAssociation{
        ...
        { "VK_KHR_get_physical_device_properties2", "VK_KHR_copy_commands2", "VK_KHR_format_feature_flags2" },
    ...
    ExtensionAssociation{
        ...
        { "VK_KHR_get_physical_device_properties2", "VK_KHR_swapchain", "VK_EXT_hdr_metadata" }
    },
    ExtensionAssociation{
    ...
    ExtensionAssociation{
        ...
        { "VK_KHR_create_renderpass2", "VK_KHR_synchronization2" }
    },
    ExtensionAssociation{
        "VK_IMG_filter_cubic",
        VK_STRUCTURE_TYPE_MAX_ENUM,
    ...
    ExtensionAssociation{
        ...
        { "VK_KHR_get_physical_device_properties2", "VK_KHR_depth_stencil_resolve" },
        VK_MAKE_VERSION(1, 3, 0)
    },
    ExtensionAssociation{
    ...
    ExtensionAssociation{
        ...
        { "VK_KHR_get_physical_device_properties2", "VK_KHR_maintenance2", "VK_KHR_image_format_list" },
        VK_MAKE_VERSION(1, 2, 0)
    },
    ExtensionAssociation{
    ...
    ExtensionAssociation{
        ...
        { "VK_KHR_get_surface_capabilities2", "VK_KHR_surface", "VK_KHR_swapchain", "VK_KHR_present_id2" }
    },
    ExtensionAssociation{
    ...
    ExtensionAssociation{
        ...
        VK_STRUCTURE_TYPE_MAX_ENUM,
        { "VK_KHR_vulkan_memory_model", "VK_KHR_shader_maximal_reconvergence" }
    },
    ExtensionAssociation{
    ...
    ExtensionAssociation{
        ...
        VK_STRUCTURE_TYPE_MAX_ENUM,
        VK_STRUCTURE_TYPE_MAX_ENUM,
        { "VK_KHR_timeline_semaphore", "VK_KHR_present_id", "VK_KHR_present_id2" }
    },
    ExtensionAssociation{
    ...
    ExtensionAssociation{
        ...
        { "VK_KHR_get_physical_device_properties2", "VK_KHR_format_feature_flags2", "VK_KHR_synchronization2" }
    },
    ExtensionAssociation{
    ...
    ExtensionAssociation{
        ...
        { "VK_KHR_maintenance5", "VK_EXT_fragment_density_map" }
    },
    ExtensionAssociation{
